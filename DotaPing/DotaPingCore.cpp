...
char *d2ServerIPSingapore[] = {"sgp-1.valve.net", "103.28.54.1", "103.28.55.1"};
char *d2ServerIPUSWest[] = {"192.69.96.1", "192.69.96.2"};
...
char *d2ServerIPLux[] = {"146.66.152.1", "146.66.153.1"};
char *d2ServerIPStockholm[] = {"146.66.156.1", "146.66.156.2"}; 
...
int getPingValueFromStockholm() {
	int tmpValue = getPingValueFromDestination(d2ServerIPStockholm[0]);
	return tmpValue;
}
